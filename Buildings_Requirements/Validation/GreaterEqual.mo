...
model GreaterEqual
  ...
  Buildings_Requirements.GreaterEqual greAct1(name="AlwaysActive", text=
  ...
  Buildings_Requirements.GreaterEqual greAct4(
...
equation
  connect(greAct1.u_max, sin.y) annotation (Line(points={{19,66},{-10,66},{-10,
          80},{-38,80}}, color={0,0,127}));
  connect(sin.y,greAct2. u_max) annotation (Line(points={{-38,80},{-10,80},{-10,
          26},{19,26}}, color={0,0,127}));
  connect(sin.y,greAct3. u_max) annotation (Line(points={{-38,80},{-10,80},{-10,
          -14},{19,-14}}, color={0,0,127}));
  connect(con.y,greAct2. u_min) annotation (Line(points={{-38,50},{-6,50},{-6,22},
          {19,22}}, color={0,0,127}));
  connect(con.y,greAct3. u_min) annotation (Line(points={{-38,50},{-6,50},{-6,-18},
          {19,-18}}, color={0,0,127}));
  connect(off.y,greAct2. active) annotation (Line(points={{-38,-20},{0,-20},{0,16},
          {18,16}},  color={255,0,255}));
  connect(booPul.y,greAct3. active) annotation (Line(points={{-38,-50},{0,-50},{
          0,-24},{18,-24}}, color={255,0,255}));
  connect(greAct1.u_min, con.y) annotation (Line(points={{19,62},{-6,62},{-6,50},
          {-38,50}}, color={0,0,127}));
  connect(con.y,greAct4. u_max) annotation (Line(points={{-38,50},{-10,50},{-10,
          -64},{19,-64}}, color={0,0,127}));
  connect(con.y,greAct4. u_min) annotation (Line(points={{-38,50},{-10,50},{-10,
          -68},{19,-68}}, color={0,0,127}));
  connect(booPul.y,greAct4. active) annotation (Line(points={{-38,-50},{0,-50},{
